defmodule Up.Products.Dynamic.Story do
  ...
  def prompts do
    [
      ...
      "PERSON ONE and PERSON TWO lie on a checkered picnic blanket in lush grass dotted with yellow flowers. PERSON ONE, in a yellow gingham dress, points skyward while holding PERSON TWO’s hand. PERSON TWO, in a mustard blazer and tie, gazes up in wonder. A picnic basket, bread, fruit, and vintage camera complete the tranquil scene.",
      ...
      "A 3D-rendered scene: PERSON ONE, in a pink floral dress, lies on a checkered blanket, smiling warmly at PERSON TWO. PERSON TWO, in a black suit jacket, light blue shirt, striped tie, and beige pants, points at the sky, speaking excitedly. A vintage camera and scattered yellow flowers set a peaceful, dreamlike mood.",
      ...
      "PERSON ONE gently hands the newborn baby to PERSON TWO. They exchange warm smiles, sharing a tender, life-changing moment as the baby settles into their arms.",
